...
public enum InputDataTypeEnum {
    ...
    GATEWAY_PUSH(new String[] {"upsta", "alarm", "adddev", "devsta", "sta", "ubd"}),
    GATEWAY_REQUEST(new String[] {"devlist", "devname"}),
    ...
    APP_RESPONSE(new String[] {"notice_gateway", "notice_device", "notice_warning"}),
